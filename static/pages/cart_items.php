          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>Rp$displayShipping</span>";
                else $displayShipping = "Rp$displayShipping";

                if ($sumTotal >= 200000){
                  $shippingTotal = $sumTotal - 10000;
                  $displayPVoucher = "<span class='underline'>-Rp10000</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                else if ($sumTotal >= 200000 && $sumTotal < 2000000){ 
